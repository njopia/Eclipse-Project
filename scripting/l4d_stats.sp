...
#include <adminmenu>
#include "l4d_stats_points_config.inc"
...
// Points configuration cvars are now defined in l4d_stats_points_config.inc
...
public OnPluginStart()
{
	...
	cvar_HumansNeeded = CreateConVar("l4d_stats_minhumans", "1", "Minimum Human players before stats will be enabled", _, true, 1.0, true, 4.0);
	...
	// Initialize all points-related ConVars from l4d_stats_points_config.inc
	InitializePointsConfig();

	// Initialize Hunter pounce distance values
	if (ServerVersion == Engine_Left4Dead)
	{
