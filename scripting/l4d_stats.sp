...
public void ClearRankCategoryHandler(Handle topmenu, TopMenuAction action, TopMenuObject object_id, int client, char[] buffer, int maxlength)
{
...
public void Menu_CreateClearMenuHandler(Handle menu, MenuAction action, int param1, int param2)
{
	switch (action)
	{
...
public void Menu_CreateClearTMMenuHandler(Handle menu, MenuAction action, int param1, int param2)
{
	switch (action)
	{
		case MenuAction_Select:
...
public void ClearRankTopItemHandler(Handle topmenu, TopMenuAction action, TopMenuObject object_id, int client, char[] buffer, int maxlength)
{
...
public void SetCurrentGamemodeName()
{
...
void QueryClientPointsDP(Handle dp, SQLTCallback callback)
{
...
void QueryClientRankDP(Handle dp, SQLTCallback callback)
{
	char query[256];
...
/*
void QueryClientGameModeRank(int Client, SQLTCallback callback=INVALID_FUNCTION)
{
	if (!InvalidGameMode())
	{
...
*/
void QueryClientGameModeRankDP(Handle dp, SQLTCallback callback)
{
	if (!InvalidGameMode())
	{
		char query[1024];
...
/*
void QueryClientGameModePoints(int Client, SQLTCallback callback=INVALID_FUNCTION)
{
	char SteamID[MAX_LINE_WIDTH];
...
void QueryClientGameModePointsStmID(int Client, const char[] SteamID, SQLTCallback callback=INVALID_FUNCTION)
{
...
*/
void QueryClientGameModePointsDP(Handle dp, SQLTCallback callback)
{
	char query[1024], SteamID[MAX_LINE_WIDTH];
...
*/
void QueryRank_1(Handle dp = INVALID_HANDLE, SQLTCallback callback = INVALID_FUNCTION)
{
	if (callback == INVALID_FUNCTION)
...
void QueryRank_2(Handle dp = INVALID_HANDLE, SQLTCallback callback = INVALID_FUNCTION)
{
	if (callback == INVALID_FUNCTION)
...
void QueryClientStatsDP(Handle dp)
{
	QueryClientGameModePointsDP(dp, QueryClientStatsDP_1);
}

public void QueryClientStatsDP_1(Handle owner, Handle hndl, const char[] error, any dp)
{
...
public void QueryClientStatsDP_2(Handle owner, Handle hndl, const char[] error, any dp)
{
	if (hndl == INVALID_HANDLE)
	{
...
public void QueryClientStatsDP_3(Handle owner, Handle hndl, const char[] error, any dp)
{
	if (hndl == INVALID_HANDLE)
	{
...
public void QueryClientStatsDP_4(Handle owner, Handle hndl, const char[] error, any dp)
{
	if (hndl == INVALID_HANDLE)
	{
...
public void QueryClientStatsDP_5(Handle owner, Handle hndl, const char[] error, any dp)
{
	if (hndl == INVALID_HANDLE)
	{
...
public void QueryClientStatsDP_6(Handle owner, Handle hndl, const char[] error, any dp)
{
	if (hndl == INVALID_HANDLE)
	{
...
public void InsertMapDB(Handle owner, Handle hndl, const char[] error, any data)
{
	if (db == INVALID_HANDLE)
		return;
...
public void InsertPlayerDB(Handle owner, Handle hndl, const char[] error, any client)
{
...
public void SetClientRankMute(Handle owner, Handle hndl, const char[] error, any client)
{
	if (db == INVALID_HANDLE || IsClientBot(client))
		return;
...
// Insert a player into the settings database if they do not already exist.
public void GetClientRankMute(Handle owner, Handle hndl, const char[] error, any client)
{
	if (db == INVALID_HANDLE || IsClientBot(client))
	{
		return;
...
public void SQLErrorCheckCallback(Handle owner, Handle hndl, const char[] error, any queryid)
{
	if (db == INVALID_HANDLE)
	{
		return;
...
// Perform player update of name, playtime, and timestamp.
public void UpdatePlayerFull(int Client, const char[] SteamID, const char[] Name)
{
...
// Report error on sql query;
public void UpdatePlayerCallback(Handle owner, Handle hndl, const char[] error, any client)
{
	if (db == INVALID_HANDLE)
	{
		return;
...
public void UpdateMapStat(const char[] Field, int Score)
{
	if (Score <= 0)
	{
		return;
...
public void DoShowRankChange(int Client)
{
	if (StatsDisabled())
		return;
...
public void DoShowPlayerJoined(int client)
{
	if (StatsDisabled())
	{
		return;
...
public void InterstitialPlayerUpdate(int client)
{
	char ClientID[MAX_LINE_WIDTH];
	GetClientRankAuthString(client, ClientID, sizeof(ClientID));
...
void GiveAdrenaline(int Giver, int Recipient, int AdrenalineID = -1)
{
...
void GivePills(int Giver, int Recipient, int PillsID = -1)
{
	// Stats enabled is checked by the caller
...
public void ClearStatsMaps(int client)
{
...
public void ClearStatsAll(int client)
{
	if (!DoFastQuery(client, "START TRANSACTION"))
	{
		return;
...
public void ClearStatsPlayers(int client)
{
	if (!DoFastQuery(client, "START TRANSACTION"))
	{
		return;
...
public void ClearStatsMapsHandler(Handle owner, Handle hndl, const char[] error, any client)
{
	if (hndl == INVALID_HANDLE)
	{
...
public void DisplayRankMenu(int client)
{
...
public void GetClientPointsPlayerJoined(Handle owner, Handle hndl, const char[] error, any client)
{
	GetClientPointsWorker(owner, hndl, error, client, GetClientRankPlayerJoined);
}

// Generate client's point total.
public void GetClientPointsRankChange(Handle owner, Handle hndl, const char[] error, any client)
{
	GetClientPointsWorker(owner, hndl, error, client, GetClientRankChange);
}

// Generate client's point total.
void GetClientPointsWorker(Handle owner, Handle hndl, const char[] error, any client, SQLTCallback callback = INVALID_FUNCTION)
{
	if (!client)
	{
		return;
...
public void GetClientGameModePoints(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client)
		return;
...
public void DisplayClientNextRank(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client)
		return;
	...
	if (hndl == INVALID_HANDLE)
	{
		LogError("GetClientRankChange Query failed: %s", error);
		return;
	}
...
// Generate client's next rank.
public void GetClientNextRank(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client)
		return;
...
public void GetClientRankChange(Handle owner, Handle hndl, const char[] error, int client)
{
	if (!client)
		return;
...
// Generate client's rank.
public void GetClientRankPlayerJoined(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client)
	{
		return;
...
// Generate client's rank.
public void GetClientRank(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client)
		return;
...
// Generate client's rank.
public void GetClientGameModeRank(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client)
		return;
...
public void GetGameModeRankTotal(Handle owner, Handle hndl, const char[] error, any data)
{
	if (hndl == INVALID_HANDLE)
	{
...
public void DisplayNextRank(int client)
{
	if (!client)
		return;
...
// Send the NEXTRANK panel to the client's display.
public void DisplayNextRankFull(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client)
		return;
...
public void StartRankVote(int client)
{
	if (L4DStatsConf == INVALID_HANDLE)
	{
		if (client > 0)
...
public void GetClientFromTop10(int client, int rank)
{
	char query[512];
...
public void GetClientFromTop10PPM(int client, int rank)
{
	char query[1024];
...
public void GetClientTop10(Handle owner, Handle hndl, const char[] error, any client)
{
...
public void ExecuteTeamShuffle(Handle owner, Handle hndl, const char[] error, any data)
{
	if (hndl == INVALID_HANDLE)
	{
...
public void CreateRanksMenu(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client || hndl == INVALID_HANDLE)
	{
...
public void CreateTimedMapsMenu(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client || hndl == INVALID_HANDLE)
	{
...
public void Menu_CreateTimedMapsMenuHandler(Handle menu, MenuAction action, int param1, int param2)
{
...
public void DisplayTimedMapsMenu2FromInfo(int client, char[] Info)
{
...
public void DisplayTimedMapsMenu2(int client, int Gamemode)
{
	char query[256];
...
public void CreateTimedMapsMenu2(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client || hndl == INVALID_HANDLE)
	{
...
public void Menu_CreateTimedMapsMenu2Hndl(Handle menu, MenuAction action, int param1, int param2)
{
	if (menu == INVALID_HANDLE)
		return;
...
public void DisplayTimedMapsMenu3FromInfo(int client, char[] Info)
{
...
public void DisplayTimedMapsMenu3(int client, int Gamemode, const char[] Map)
{
	Handle dp = CreateDataPack();
...
public void DisplayTimedMapsMenu3_2(Handle owner, Handle hndl, const char[] error, any dp)
{
	if (hndl == INVALID_HANDLE)
	{
		if (dp != INVALID_HANDLE)
...
public void CreateTimedMapsMenu3(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client || hndl == INVALID_HANDLE)
	{
...
public void Menu_CreateTimedMapsMenu3Hndl(Handle menu, MenuAction action, int param1, int param2)
{
	if (menu == INVALID_HANDLE)
		return;
...
public void DisplayTimedMapsMenu4FromInfo(int client, char[] Info)
{
...
public void DisplayTimedMapsMenu4(int client, int Gamemode, const char[] Map, float MapTime)
{
	char query[256];
...
public void CreateTimedMapsMenu4(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client || hndl == INVALID_HANDLE)
	{
...
public void Menu_CreateTimedMapsMenu4Hndl(Handle menu, MenuAction action, int param1, int param2)
{
	if (menu == INVALID_HANDLE)
		return;
...
public void CreatePPMMenu(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client || hndl == INVALID_HANDLE)
	{
...
public void Menu_CreateRanksMenuHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (menu == INVALID_HANDLE)
		return;
...
public void Menu_CreateRankMenuHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (menu == INVALID_HANDLE)
		return;
...
public void DisplayAboutPanel(int client)
{
	char   Value[MAX_LINE_WIDTH];
...
// Send the RANKABOUT panel to the client's display.
public void DisplaySettingsPanel(int client)
{
	char   Value[MAX_LINE_WIDTH];
...
public void DisplayTop10PPM(Handle owner, Handle hndl, const char[] error, any client)
{
	if (!client || hndl == INVALID_HANDLE)
	{
...
public void RankPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
}

// Handler for NEXTRANK panel.
public void NextRankPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (param2 == 1)
...
// Handler for NEXTRANK panel.
public void NextRankFullPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
}

// Handler for TIMEDMAPS panel.
public void TimedMapsPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
}
...
// Handler for RANKADMIN panel.
public void ClearPlayersPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void ClearMapsPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void ClearAllPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void CleanPlayersPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void RemoveCustomMapsPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void ClearTMAllPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void ClearTMCoopPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void ClearTMSurvivalPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void ClearTMRealismPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
// Handler for RANKADMIN panel.
public void ClearTMMutationsPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action != MenuAction_Select)
		return;
...
public void RankVotePanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
...
// Handler for RANKADMIN panel.
public void DisplayClearPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (menu == INVALID_HANDLE)
		return;
...
public void AboutPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action == MenuAction_Select)
	{
		if (param2 == 1)
...
public void SettingsPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action == MenuAction_Select)
	{
		if (param2 == 1)
...
public void Top10PanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action == MenuAction_Select)
	{
		if (param2 == 0)
...
public void Top10PPMPanelHandler(Handle menu, MenuAction action, int param1, int param2)
{
	if (action == MenuAction_Select)
	{
		if (param2 == 0)
...
public void ResetRankChangeCheck()
{
	int maxplayers = MaxClients;
...
public void StartRankChangeCheck(int Client)
{
	if (TimerRankChangeCheck[Client] != INVALID_HANDLE)
		CloseHandle(TimerRankChangeCheck[Client]);
...
public void UpdateSmokerDamage(int Client, int Damage)
{
...
public void UpdateSpitterDamage(int Client, int Damage)
{
	if (Client <= 0 || Damage <= 0 || IsClientBot(Client))
		return;
...
public void UpdateJockeyDamage(int Client, int Damage)
{
	if (Client <= 0 || Damage <= 0 || IsClientBot(Client))
		return;
...
public void UpdateChargerDamage(int Client, int Damage)
{
	if (Client <= 0 || Damage <= 0 || IsClientBot(Client))
		return;
...
bool CheckSurvivorsAllDown()
{
	...
	int[] KilledSurvivor = new int[MaxClients];
	int[] AliveInfected	 = new int[MaxClients];
	int[] Infected		 = new int[MaxClients];
...
/*
bool IsGamemodeRealism()
{
	return IsGamemode("realism");
}

bool IsGamemodeRealismVersus()
{
	return IsGamemode("mutation12");
}

bool IsGamemodeScavenge()
{
...
/*
void UpdatePlayerScore(int Client, int Score)
{
	if (Score == 0)
		return;
...
void UpdatePlayerScoreVersus(int Client, int ClientTeam, int Score)
{
	if (Score == 0)
		return;
...
void UpdatePlayerScoreRealismVersus(int Client, int ClientTeam, int Score)
{
	if (Score == 0)
		return;
...
void UpdatePlayerScoreScavenge(int Client, int ClientTeam, int Score)
{
	if (Score == 0)
		return;
...
void SurvivorDiedNamed(int Attacker, int Victim, const char[] VictimName, const char[] AttackerID, int AttackerInfType = -1, int Mode = -1)
{
	if (!Attacker || !Victim || StatsGetClientTeam(Attacker) != TEAM_INFECTED || StatsGetClientTeam(Victim) != TEAM_SURVIVORS)
		return;
...
void SurvivorHurt(int Attacker, int Victim, int Damage, int AttackerInfType = -1, Handle event = INVALID_HANDLE)
{
...
void SurvivorHurtExternal(Handle event, int Victim)
{
...
public void StatsPrintToChatTeam(int Team, const char[] Message, any...)
{
...
public void UpdateMapTimingStat(Handle owner, Handle hndl, const char[] error, any dp)
{
	if (hndl == INVALID_HANDLE)
	{
		if (dp != INVALID_HANDLE)
...
public void StatsPrintToChat(int Client, const char[] Message, any...)
{
