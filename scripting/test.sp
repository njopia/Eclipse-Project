...
{
	name		= "Spawn Ammo (Debug)",
	author		= "Socius + ChatGPT",
	description = "Spawnea pila y packs mejorados con cooldown/vida y logs de debug.",
	version		= "1.2.0",
	url			= ""
};
...
{
	RegConsoleCmd("sm_spawnammo", Cmd_SpawnAmmo, "sm_spawnammo <pile|explosive|incendiary>");
	g_cvarDebug = CreateConVar("sm_spawnammo_debug", "0", "Activa debug verboso (0/1).", 0, true, 0.0, true, 1.0);

	PrintToServer("[SpawnAmmo] Cargado. Debug=%d", g_cvarDebug.IntValue);
}
